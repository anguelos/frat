...
frat_gui_config_diplomatics = json.loads(pkgutil.get_data(__name__, "resources/diplomatics_annotation_config.json").decode("utf-8"))
...
from .formats import rectangles_to_img